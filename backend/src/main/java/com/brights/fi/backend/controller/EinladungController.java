...
//	@PostMapping("/simpel/anfrage")
//	@CacheEvict(value = "einladungen", key = "#benutzerId")
//	public ResponseEntity<Benutzer> erstelleEinladungSimpelAnfrage(
//			@RequestParam Long ausflugId,
...
//	}
	...
	@PostMapping("/simpel/anfrage/{ausflugId}/{benutzerId}")
	@CacheEvict(value = "einladungen", key = "#benutzerId")
	public ResponseEntity<Benutzer> erstelleEinladungSimpelEinladung(
	...
	@CacheEvict(value = "einladungen", allEntries = true)
	...
	@CacheEvict(value = "einladungen", key = "#einladungId")
	...
	@GetMapping("/benutzer")
	@Cacheable(value = "einladungen", key = "#benutzerId")
