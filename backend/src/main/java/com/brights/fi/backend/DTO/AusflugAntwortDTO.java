...
public class AusflugAntwortDTO {
	...
	private Set<Long> teilnehmerIds;
	...
	public Set<Long> getTeilnehmerIds() {
		return teilnehmerIds;
	}

	public void setTeilnehmerIds(Set<Long> teilnehmerIds) {
		this.teilnehmerIds = teilnehmerIds;
	}
